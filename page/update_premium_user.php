...
class updateProfile extends database
{
    ...
    {
        $name = $_GET['name'];
        $sql = "select * from premium_user where username = '$name' ";
    ...
    public function updateFunction()
    {
        ...
        if (isset($_POST['update'])) {
            ...
            if ($_FILES['image']['name'] == '') {
                $sql2 = "Update premium_user set password = '$pass', country = '$country', fname = '$fname', lname = '$lname'  where username = '$name'";
            } else {
                $sql2 = "Update premium_user set password = '$pass', country = '$country', fname = '$fname', image = '$img', lname = '$lname'  where username = '$name'";
