    ...
    <section>
        ...
        <div class="jumbotron text-center">
            <div class="container">
                ...
                <a href="standard_page_data.php?name=<?php echo $row['period_name']; ?>"
    ...
    <section>
        ...
        <div class="jumbotron text-center">
            <div class="container">
                ...
                <h1 style="text-transform:uppercase"><?php echo $row['period_name']; ?></h1>
                <a href="country_middle_standard.php?name=<?php echo $row['period_name']; ?>"
                    class="btn btn-info"><?php echo $row['time']; ?> <span class="badge ml-2 badge-light">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a target="__blank" href="coinimg.php?id=<?php echo $row['id']; ?>"><img
                                    src="../coin_img/<?php echo $row['image']; ?>" style="width: 100%" alt="sena coins"
