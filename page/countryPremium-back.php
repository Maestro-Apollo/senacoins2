    ...
    <section>
        ...
        <div class="jumbotron text-center">
            <div class="container">
                ...
                <h1 style="text-transform: uppercase"><?php echo $row['period_name']; ?></h1>
                <a href="premium_page_data.php?name=<?php echo $row['period_name']; ?>"
                    class="btn btn-info"><?php echo $row['time']; ?></a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="coinimg.php?id=<?php echo $row['id']; ?>" target="__blank"><img
                                    style="width: 100%;" src="../coin_img/<?php echo $row['image']; ?>"
                                    style="width: 20%" alt="sena coins" onerror='this.style.display = "none"'>
                            </a>
                        </td>
