            ...
            if (mysqli_num_rows($res) > 0) {
                ...
                if (mysqli_num_rows($res2) > 0) {
                    ...
                    if (mysqli_num_rows($resName) > 0) {
                        ...
                        $sql5 = "UPDATE `code` SET `taken`=$update_value,`updated`= CURRENT_TIMESTAMP WHERE code = $code ";
...
<body style="background-color: #fff">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#" data-toggle="modal" data-target="#codeModal">Upgrade <span
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="submission.php?name=<?php echo $_SESSION['name']; ?>">Submission</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="update_standard_user.php?name=<?php echo $_SESSION['name']; ?>">Update</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="alert alert-success w-25 mx-auto text-center">
        ...
        <p class="mt-2"><a href="deleteReplyMsg.php?id= <?php echo $rowR['id']; ?> " class="btn btn-danger">Close</a>
        </p>
    ...
    <div class="container">
        ...
        <div class="alert alert-warning alert-dismissible">
            ...
            <strong class="text-center text-capitalize">Buy the book or the code is used</strong>
        </div>
        <?php }  ?>
    </div>
                            ...
                            <div class="row text-light">
                                <div class="col-md-6 text-left">
                                    <div class="container">
                                        ...
                                        <p class="lead mt-1">Description: <?php echo $row['description']; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div>
                                    <a class="btn btn-dark" style="text-transform:uppercase"
                                        href="standard_page_data.php?name=<?php echo $row['timeperiod']; ?>">
                                        <?php echo $row['timeperiod']; ?> </a>
                                    <a class="btn btn-dark" style="text-transform:uppercase"
                                        href="countryStandard.php?code=<?php echo $row['code']; ?>">
                                        <?php echo $row['code']; ?> </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                <div class="">
                                    ...
                                    <!-- <img src="../coin_img/<?php echo $row2['image']; ?>" style="width: 30%" alt="">
                                    <img src="../coin_img/<?php echo $row2['image2']; ?>" style="width: 30%" alt="">
                                    <img src="../coin_img/<?php echo $row2['image3']; ?>" style="width: 30%" alt="">
                                    <img src="../coin_img/<?php echo $row2['image4']; ?>" style="width: 30%" alt="">
                                    <img src="../coin_img/<?php echo $row2['image5']; ?>" style="width: 30%" alt=""> -->
                                </div>
                            </div>
                        </div>
                    </div>
