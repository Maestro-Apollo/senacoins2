...
<body style="background-color: #1c1d26">
    ...
    <div class="p-3">
        <div class="text-center pt-4">
            <?php if ($_GET['id'] == 1) { ?>
            <h1 class="text-light font-weight-bold">Your Request is Pending</h1>
            <?php } ?>
            <?php if ($_GET['id'] == 2) { ?>
            <h1 class="text-light font-weight-bold">Certificate is registered</h1>
            <?php } ?>
            <?php if ($_GET['id'] == 3) { ?>
            <h1 class="text-light font-weight-bold">Your certificate will be reviewed by admin</h1>
            <?php } ?>
