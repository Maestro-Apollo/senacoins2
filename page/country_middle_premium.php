...
<body style="background-color: #1c1d26">
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand text-light" href="premium_page.php">Sena Coins</a>
    ...
    <section>
        ...
        <div class="jumbotron text-center">
            <div class="container">
                ...
                <a href="premium_page_data.php?name=<?php echo $row['emperor']; ?>" class="btn btn-info">Search<span
                        class="badge ml-2 badge-light">
                        <?php echo $obj->coinNumber($row['emperor']) . ' Coins'; ?></span></a>
